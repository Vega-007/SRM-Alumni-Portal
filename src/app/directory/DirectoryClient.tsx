          ...
          <div className="flex flex-col gap-6 w-full lg:flex-row items-start">
            ...
            <div className="w-full lg:w-72 shrink-0 rounded-2xl border border-slate-200/80 dark:border-slate-800/60 bg-white/60 dark:bg-slate-950/60 backdrop-blur-md p-6 lg:sticky lg:top-24 shadow-sm relative clear-both mb-6">
              ...
              <div className="space-y-6">
                {/* Name/Keyword search */}
                <div>
                  <label htmlFor="keyword-search" className="block text-xs font-semibold text-slate-500 dark:text-slate-500 uppercase tracking-wider mb-2">
                    Keyword Search
                  </label>
                ...
                {/* Batch Dropdown */}
                <div>
                  <label htmlFor="batch-select" className="block text-xs font-semibold text-slate-500 dark:text-slate-500 uppercase tracking-wider mb-2">
                    Graduation Year
                  </label>
                  <select
                    id="batch-select"
                  ...
                  >
                    ...
                    {batchOptions.reduce((acc: React.ReactNode[], batch) => {
                      if (batch !== "All") {
                        acc.push(
                ...
                {/* Company Dropdown */}
                <div>
                  <label htmlFor="company-select" className="block text-xs font-semibold text-slate-500 dark:text-slate-500 uppercase tracking-wider mb-2">
                  ...
                  >
                    ...
                    {companyOptions.reduce((acc: React.ReactNode[], company) => {
                      if (company !== "All") {
                        acc.push(
                      ...
                      >
                        <div>
                          ...
                          <div className="flex items-center gap-4">
                            <div className="h-12 w-12 rounded-xl overflow-hidden bg-slate-200 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 shrink-0 relative">
                              <Image
                                src={alumni.imageUrl}
                                alt={alumni.name}
                                fill
                        ...
                        <div className="flex items-center justify-between mt-5 pt-3 border-t border-slate-200 dark:border-slate-900/60">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <a
                              ...
                              aria-label={`Visit ${alumni.name}'s LinkedIn profile`}
                            >
